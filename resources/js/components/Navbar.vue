        ...
        <div class="w-1/3">
            <div class="flex">
                ...
                <div class="ml-2 relative">
                    <div class="absolute text-gray-700 hover:text-gray-400">
                    ...
                    <input type="text"
                           ...
                           class="w-56 bg-gray-200 h-8
                           rounded-full focus:outline-none
                           focus:shadow-outline focus:ring-1
                           focus:ring-sky-500 font-sm pl-8 text-sm"
                    >
                </div>
            </div>
        </div>
        <div class="w-1/3 flex justify-center items-center h-full" v-if="!loading">
            <router-link to="/" class="px-6 h-full border-b-2 border-blue-500 flex items-center">
            ...
            <router-link :to="/users/ + authUser.data.user_id" class="px-6 h-full border-b-2 border-white flex items-center">
