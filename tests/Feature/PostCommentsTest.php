...
class PostCommentsTest extends TestCase
{
    ...
    //php artisan test --filter a_user_can_comment_on_a_post
    ...
    public function a_user_can_comment_on_a_post()
    {
        ...
        $this->assertEquals('A great comment.', $comment->body);
        $response->assertJson([
            'data' => [
                [
                    'data' => [
    ...
    //php artisan test --filter a_body_is_required_to_leave_a_comment_on_a_post
    ...
    //php artisan test --filter posts_are_returned_with_comments
